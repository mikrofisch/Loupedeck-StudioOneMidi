...
//                }
        ...
        private void InitColorDict()
        {
            ...
            ColorDict.Add(("Analog Delay", "Delay Beats"), new ColorSettings { LinkedParameter = "Delay Sync", Label = "TIME", DialSteps = 40, OnColor = new FinderColor(107, 113, 230), TextOnColor = FinderColor.White, OffColor = new FinderColor(25, 28, 55), TextOffColor = FinderColor.Black });
            ...
            ColorDict.Add(("bx_console SSL 4000 E", "Loupedeck User Pages"), new ColorSettings { UserMenuItems = ["EQ 1", "EQ 2", "DYN", "DN/MX"  ] });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ On/Off"), new ColorSettings { Label = "EQ", OnColor = bxSslLedGreenColor, TextOnColor = FinderColor.Black, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "Dyn On/Off"), new ColorSettings { Label = "DYN", OnColor = bxSslLedGreenColor, TextOnColor = FinderColor.Black, TextOffColor = FinderColor.Black });
            ...
            ColorDict.Add(("bx_console SSL 4000 E", "HPF On/Off"), new ColorSettings { Label = "Off", LabelOn = "On", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ...
            ColorDict.Add(("bx_console SSL 4000 E", "LPF On/Off"), new ColorSettings { Label = "Off", LabelOn = "On", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "FLT Position"), new ColorSettings { Label = "DYN SC", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ High Gain"), new ColorSettings { Label = "HF Gain", OnColor = bxSslRed, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ High Frequency"), new ColorSettings { Label = "HF Freq", OnColor = bxSslRed, OnTransparency = bxSslOnTransparency });
            ...
            ColorDict.Add(("bx_console SSL 4000 E", "EQ Low Gain"), new ColorSettings { Label = "LF Gain", LinkedParameter = "EQ Type", OnColor = bxSslBrown, OnTransparency = 255, TextOnColor = FinderColor.White, OffColor = bxSslBlack, TextOffColor = FinderColor.White });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ Low Frequency"), new ColorSettings { Label = "LF Freq", LinkedParameter = "EQ Type", OnColor = bxSslBrown, OnTransparency = 255, TextOnColor = FinderColor.White, OffColor = bxSslBlack, TextOffColor = FinderColor.White });
            ...
            ColorDict.Add(("bx_console SSL 4000 E", "EQ Type"), new ColorSettings { Label = "EQ TYPE", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ High Mid Gain"), new ColorSettings { Label = "HMF Gain", OnColor = bxSslGreen, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ High Mid Frequency"), new ColorSettings { Label = "HMF Freq", OnColor = bxSslGreen, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ High Mid Q"), new ColorSettings { Label = "HMF Q", OnColor = bxSslGreen, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ Low Mid Gain"), new ColorSettings { Label = "LMF Gain", OnColor = bxSslBlue, OnTransparency = (Int32)(bxSslOnTransparency * 0.8) });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ Low Mid Frequency"), new ColorSettings { Label = "LMF Freq", OnColor = bxSslBlue, OnTransparency = (Int32)(bxSslOnTransparency * 0.8) });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ Low Mid Q"), new ColorSettings { Label = "LMF Q", OnColor = bxSslBlue, OnTransparency = (Int32)(bxSslOnTransparency * 0.8) });
            ColorDict.Add(("bx_console SSL 4000 E", "LC Ratio"), new ColorSettings { Label = "LC RATIO", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 E", "LC Threshold"), new ColorSettings { Label = "LC THRES", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 E", "LC Release"), new ColorSettings { Label = "LC REL", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 E", "LC Attack"), new ColorSettings { Label = "FAST", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "LC Link"), new ColorSettings { Label = "LINK", OnColor = bxSslYellow, TextOnColor = FinderColor.Black, OffColor = bxSslButtonOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "GE Range"), new ColorSettings { Label = "GE RANGE", OnColor = bxSslGreen, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 E", "GE Threshold"), new ColorSettings { Label = "GE THRES", OnColor = bxSslGreen, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 E", "GE Release"), new ColorSettings { Label = "GE REL", OnColor = bxSslGreen, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 E", "GE Attack"), new ColorSettings { Label = "FAST", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "GE Mode"), new ColorSettings { Label = "EXP", LabelOn = "GATE", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "GE Invert"), new ColorSettings { Label = "NORM", LabelOn = "INV", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "GE Threshold Range"), new ColorSettings { Label = "-30 dB", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "LC Highpass"), new ColorSettings { Label = "LC HPF", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 E", "LC 2nd Thresh Level"), new ColorSettings { Label = "LC REL2", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 E", "LC Mix"), new ColorSettings { Label = "LC MIX", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 E", "In Gain"), new ColorSettings { Label = "IN GAIN", OnColor = bxSslWhite, OnTransparency = 180, TextOnColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "Virtual Gain"), new ColorSettings { Label = "V GAIN", OnColor = bxSslRed, OnTransparency = 180 });
            ColorDict.Add(("bx_console SSL 4000 E", "Out Gain"), new ColorSettings { Label = "OUT GAIN", OnColor = bxSslWhite, OnTransparency = 180, TextOnColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "Phase"), new ColorSettings { Label = "PHASE", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = new FinderColor(100, 100, 100), TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "Stereo Mode"), new ColorSettings { Label = "ANALOG", LabelOn = "DIGITAL", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslYellow, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 E", "EQ Position"), new ColorSettings { Label = "", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, UserMenuItems = ["PRE DYN", "DYN SC", "POST DYN"] });
            ColorDict.Add(("bx_console SSL 4000 E", "Dyn Key"), new ColorSettings { Label = "D 2 KEY", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslButtonOffColor, TextOffColor = FinderColor.Black });
            ...
            ColorDict.Add(("bx_console SSL 4000 G", "Loupedeck User Pages"), new ColorSettings { UserMenuItems = ["EQ 1", "EQ 2", "DYN", "DN/MX"] });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ On/Off"), new ColorSettings { Label = "EQ", OnColor = bxSslLedGreenColor, TextOnColor = FinderColor.Black, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "Dyn On/Off"), new ColorSettings { Label = "DYN", OnColor = bxSslLedGreenColor, TextOnColor = FinderColor.Black, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "HPF Frequency"), new ColorSettings { Label = "HP Frq", LinkedParameter = "HPF On/Off", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "HPF On/Off"), new ColorSettings { Label = "Off", LabelOn = "On", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "LPF Frequency"), new ColorSettings { Label = "LP Frq", LinkedParameter = "LPF On/Off", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "LPF On/Off"), new ColorSettings { Label = "Off", LabelOn = "On", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "FLT Position"), new ColorSettings { Label = "DYN SC", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ High Gain"), new ColorSettings { Label = "HF Gain", LinkedParameter = "EQ Type", OnColor = bxSslMagenta, OnTransparency = 255, TextOnColor = FinderColor.White, OffColor = bxSslRed, TextOffColor = FinderColor.White });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ High Frequency"), new ColorSettings { Label = "HF Freq", LinkedParameter = "EQ Type", OnColor = bxSslMagenta, OnTransparency = 255, TextOnColor = FinderColor.White, OffColor = bxSslRed, TextOffColor = FinderColor.White });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ High Bell"), new ColorSettings { Label = "SHELF", LabelOn = "BELL", LinkedParameter = "EQ Type", LinkReversed = true, OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Low Gain"), new ColorSettings { Label = "LF Gain", LinkedParameter = "EQ Type", LinkReversed = true, OnColor = bxSslOrange, OnTransparency = 255, TextOnColor = FinderColor.White, OffColor = bxSslBlack, TextOffColor = FinderColor.White });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Low Frequency"), new ColorSettings { Label = "LF Freq", LinkedParameter = "EQ Type", LinkReversed = true, OnColor = bxSslOrange, OnTransparency = 255, TextOnColor = FinderColor.White, OffColor = bxSslBlack, TextOffColor = FinderColor.White });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Low Bell"), new ColorSettings { Label = "SHELF", LabelOn = "BELL", LinkedParameter = "EQ Type", LinkReversed = true, OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Type"), new ColorSettings { Label = "EQ TYPE", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ High Mid Gain"), new ColorSettings { Label = "HMF Gain", OnColor = bxSslCyan, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ High Mid Frequency"), new ColorSettings { Label = "HMF Freq", OnColor = bxSslCyan, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ High Mid Q"), new ColorSettings { Label = "HMF Q", OnColor = bxSslCyan, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ High Mid x3"), new ColorSettings { Label = "x3", LinkedParameter = "EQ Type", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Low Mid Gain"), new ColorSettings { Label = "LMF Gain", OnColor = bxSslBlue, OnTransparency = (Int32)(bxSslOnTransparency * 0.8) });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Low Mid Frequency"), new ColorSettings { Label = "LMF Freq", OnColor = bxSslBlue, OnTransparency = (Int32)(bxSslOnTransparency * 0.8) });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Low Mid Q"), new ColorSettings { Label = "LMF Q", OnColor = bxSslBlue, OnTransparency = (Int32)(bxSslOnTransparency * 0.8) });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Low Mid /3"), new ColorSettings { Label = "/3", LinkedParameter = "EQ Type", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "LC Ratio"), new ColorSettings { Label = "LC RATIO", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "LC Threshold"), new ColorSettings { Label = "LC THRES", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "LC Release"), new ColorSettings { Label = "LC REL", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "LC Attack"), new ColorSettings { Label = "FAST", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "LC Link"), new ColorSettings { Label = "LINK", OnColor = bxSslYellow, TextOnColor = FinderColor.Black, OffColor = bxSslButtonOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "GE Range"), new ColorSettings { Label = "GE RANGE", OnColor = bxSslCyan, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 G", "GE Threshold"), new ColorSettings { Label = "GE THRES", OnColor = bxSslCyan, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 G", "GE Release"), new ColorSettings { Label = "GE REL", OnColor = bxSslCyan, OnTransparency = bxSslOnTransparency });
            ColorDict.Add(("bx_console SSL 4000 G", "GE Attack"), new ColorSettings { Label = "FAST", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "GE Mode"), new ColorSettings { Label = "EXP", LabelOn = "GATE", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "GE Invert"), new ColorSettings { Label = "NORM", LabelOn = "INV", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslButtonColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "GE Threshold Range"), new ColorSettings { Label = "-30 dB", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslLedOffColor, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "LC Highpass"), new ColorSettings { Label = "LC HPF", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "LC 2nd Thresh Level"), new ColorSettings { Label = "LC REL2", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "LC Mix"), new ColorSettings { Label = "LC MIX", OnColor = bxSslWhite });
            ColorDict.Add(("bx_console SSL 4000 G", "In Gain"), new ColorSettings { Label = "IN GAIN", OnColor = bxSslWhite, OnTransparency = 180, TextOnColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "Virtual Gain"), new ColorSettings { Label = "V GAIN", OnColor = bxSslMagenta, OnTransparency = 180 });
            ColorDict.Add(("bx_console SSL 4000 G", "Out Gain"), new ColorSettings { Label = "OUT GAIN", OnColor = bxSslWhite, OnTransparency = 180, TextOnColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "Phase"), new ColorSettings { Label = "PHASE", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = new FinderColor(100, 100, 100), TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "Stereo Mode"), new ColorSettings { Label = "ANALOG", LabelOn = "DIGITAL", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, OffColor = bxSslYellow, TextOffColor = FinderColor.Black });
            ColorDict.Add(("bx_console SSL 4000 G", "EQ Position"), new ColorSettings { Label = "", OnColor = bxSslButtonColor, TextOnColor = FinderColor.Black, UserMenuItems = ["PRE DYN", "DYN SC", "POST DYN"] });
            ColorDict.Add(("bx_console SSL 4000 G", "Dyn Key"), new ColorSettings { Label = "D 2 KEY", OnColor = bxSslLedRedColor, TextOnColor = FinderColor.White, OffColor = bxSslButtonOffColor, TextOffColor = FinderColor.Black });
            ...
            ColorDict.Add(("H-Delay", "Delay BPM"), new ColorSettings { Label = "DELAY", LinkedParameter = "Sync", LinkedStates = "0,1", DialSteps = 19, OnColor = hybridLineColor, OnTransparency = 255, TextOnColor = FinderColor.Black });
            ColorDict.Add(("H-Delay", "Delay Sec"), new ColorSettings { Label = "DELAY", LinkedParameter = "Sync", LinkedStates = "2", OnColor = hybridLineColor, OnTransparency = 255, TextOnColor = FinderColor.Black });
            ...
            ColorDict.Add(("H-Comp", "Release"), new ColorSettings { LinkedParameter = "Sync", Label = "RELEASE", LinkedStates = "2", OnColor = hybridLineColor, OnTransparency = 255, TextOnColor = FinderColor.Black });
            ColorDict.Add(("H-Comp", "ReleaseBPM"), new ColorSettings { LinkedParameter = "Sync", Label = "RELEASE", LinkedStates = "0,1", DialSteps = 19, OnColor = hybridLineColor, OnTransparency = 255, TextOnColor = FinderColor.Black });
