namespace Loupedeck.StudioOneMidiPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.StudioOneMidiPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.StudioOneMidiPlugin.Resources.Resource.txt`.
