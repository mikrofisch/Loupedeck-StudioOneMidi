namespace Loupedeck.StudioOneMidiPlugin.Controls
{
    ...
    class CommandButton : StudioOneButton<CommandButtonData>
	{
		public CommandButton()
		{
            ...
            this.AddButton(new OneWayCommandButtonData(14, 0x0C, "Marker Track", "show_markers"), "View");
            this.AddButton(new OneWayCommandButtonData(14, 0x0D, "Signature Track", "ruler_signature"), "View");
            this.AddButton(new OneWayCommandButtonData(14, 0x0E, "Tempo Track", "ruler_tempo"), "View");
            this.AddButton(new OneWayCommandButtonData(14, 0x0F, "Fit Timeline"), "View");
